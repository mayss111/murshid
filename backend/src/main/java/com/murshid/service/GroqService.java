...
public class GroqService {
    ...
    public List<Map<String, Object>> genererParcoursComplet(String matiere, int niveau) {
        try {
            String prompt = "أنت معلّم إسلامي متميّز. صمّم مسار تعلّم كاملاً لمادة '" + matiere
                ...
                + "ب الأسلوب التربوي: مقدمة، شرح المفاهيم، أمثلة، آيات/أحاديث، تطبيق، خاتمة)، "
            ...
            return null; // signal pour utiliser le fallback
        } catch (Exception ex) {
    ...
    public List<Map<String, String>> getFallbackPlanLecons(String matiere, int niveau) {
